    ...
    methods: {
      ...
      onExpand(expandedKeys, node) {
        ...
        let tree = {
          ...
          "title": "老李222",
          "isLeaf": true,
          "id": "a42e35cf358c4f79bb9d13f672ea7b64",
          "parentId": "a42e35cf358c4f79bb9d13f672ea7b64",
          "departName": "老李222",
          "departNameEn": null,
          "departNameAbbr": null,
          "departOrder": 0,
          ...
          "delFlag": "0",
          "createBy": "admin",
          "createTime": "2020-08-03 09:45:15",
          "updateBy": null,
          "updateTime": null,
          "children": null
        }
        //node.node.$vnode.data.props.dataRef.child.push(tree)
        //node.node.$children.push(tree)
       //node.data.children.push(tree)
        console.log(node)
