...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          exportXlsUrl: "/system/mpiGateway/exportXls",
          importExcelUrl: "system/mpiGateway/importExcel",
        },
        dictOptions:{},
        pcaData:''
      }
    ...
    methods: {
      ...
      handleAdd: function () {
        if ('' != this.companyId) {
          this.$refs.modalForm.companyIds = this.companyId;
        }
        this.$refs.modalForm.add();
        this.$refs.modalForm.title = "新增";
        // console.log("idddddd : " + this.companyId)
