...
var PDFHistory = {
  ...
  initialize: function pdfHistoryInitialize(fingerprint, linkService) {
    ...
    function pdfHistoryBeforeUnload() {
      ...
      // Remove the event config when navigating away from the document,
    ...
    window.addEventListener('pageshow', function pdfHistoryPageShow(evt) {
      ...
      // we need to reattach the 'beforeunload' event config since
...
var PDFDocumentProperties = (function PDFDocumentPropertiesClosure() {
  ...
  function PDFDocumentProperties(options) {
    ...
    // Bind the event config for the Close button.
